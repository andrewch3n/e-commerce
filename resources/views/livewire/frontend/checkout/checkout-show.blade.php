        ...
        <div class="container">
                        ...
                        <div class="shadow bg-white p-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" wire:model.defer="pincode" id="pincode" class="form-control"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea wire:model.defer="address" id="address" class="form-control" rows="3"></textarea>
                                    @error('address')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                    ...
                                    <div class="d-md-flex align-items-start">
                                        <div class="nav col-md-3 flex-column nav-pills me-3" id="v-pills-tab"
                                            ...
                                            <button wire:loading.attr="disabled" class="nav-link fw-bold"
                                                ...
                                                aria-controls="onlinePayment" aria-selected="false">Online Payment
                                            </button>
                                        </div>
                                        <div class="tab-content col-md-9" id="v-pills-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="onlinePayment" role="tabpanel"
                                                ...
                                                <hr />
                                                {{-- <button type="button" wire:loading.attr="disabled"
                                                    class="btn btn-warning">Pay Now (Online Payment)
                                                </button> --}}
                                                <div>
            ...
            @else
                <div class="card card-body shadow text-center p-md-5">
                    ...
                    <a href="{{ url('collections') }}" class="btn btn-danger w-50 align-self-center">Shop Now</a>
                </div>
            @endif
...
@push('scripts')
    <script
        src="https://www.paypal.com/sdk/js?client-id=AVrsHJ7lD8vk4RH5QZuIFNwX_s29oAH2O-61urXcr8WHx5p2QN6iXZ9Uc3cyxgkYbgicPCxt8UmK0Y2n&currency=USD">
    </script>
    <script>
        paypal.Buttons({
            onClick: function() {
