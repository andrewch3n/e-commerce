<div>
    <div class="footer-area">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h4 class="footer-heading">Andrew's E-Commerce</h4>
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2"><a href="{{ url('/trendings') }}" class="text-white">Trending Products</a></div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2">
                        <a href="" class="text-white">
                            <i class="fa fa-envelope"></i> andrewchen3198@gmail.com
                        </a>
                    </div>
                </div>
            </div>
